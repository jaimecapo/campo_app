...
export const Campos = () => {
  ...
  //obtiene todos los campos en el primer renderizado unicamente.
  useEffect(()=>{
  ...
  //borra el campo del array que se esta visualizando.
  ...
  //borra el campo de la base de datos.
  ...
  //decide si devolver la descripcion de un campo, la lista con todos o el formulario de creacion.
