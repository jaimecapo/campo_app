...
function LoginForm({ onClick, setLogued }) {
  ...
  //hace una llamada a través de fetch para comprobar si los valores del registro son correctos
  ...
  //guarda los parametros del usuario en el localStorage para recordar la sesion 
...
function RegisterForm({ onClick, changeRegister }) {
  ...
  //a través de fetch crea un usuario y te da paso a la pestaña login otra vez
